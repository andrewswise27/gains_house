...
session7 = Session('Hot Yoga', '2022-07-26 12:00:00', 75, 10, 'Hot yoga is a vigorous form of yoga performed in a very warm and humid studio.', 'Expert')
session8 = Session('Crossfit', '2022-07-28 13:30:00', 75, 8, 'A form of high intensity interval training, CrossFit is a strength and conditioning workout that is made up of functional movement performed at a high intensity level.', 'Intermediate')
session9 = Session('Vinyasa Yoga', '2022-07-28 12:00:00', 65, 10, 'A Vinyasa yoga practice connects individual poses or “asanas” with deep breaths or “pranayama” in a series of flowing sequences of movement. Designed to progressively open the body, each sequence in a Vinyasa yoga class builds upon the previous, evolving into deeper, more advanced postures as the practice unfolds.', 'Intermediate')
...
session13 = Session('Body Pump', '2022-08-03 09:00:00', 45, 10, "BODYPUMP is a fast-paced, barbell-based workout that's specifically designed to help you get lean, toned and fit.", 'Beginner')
session14 = Session('Body Pump', '2022-08-03 15:00:00', 45, 10, "BODYPUMP is a fast-paced, barbell-based workout that's specifically designed to help you get lean, toned and fit.", 'Beginner')
session15 = Session('Zumba', '2022-08-06 18:00:00', 60, 8, "Zumba is a form of fitness class in which you burn off calories by dancing to different kinds of lively tunes.", 'Intermediate')
session16 = Session('Zumba', '2022-08-06 21:00:00', 60, 8, "Zumba is a form of fitness class in which you burn off calories by dancing to different kinds of lively tunes.", 'Intermediate')
session17 = Session('Vinyasa Yoga', '2023-01-01 17:00:00', 100, 1, 'A Vinyasa yoga practice connects individual poses or “asanas” with deep breaths or “pranayama” in a series of flowing sequences of movement. Designed to progressively open the body, each sequence in a Vinyasa yoga class builds upon the previous, evolving into deeper, more advanced postures as the practice unfolds.', 'Beginner')
